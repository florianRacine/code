...
function minMax(maximizingPlayer) {
    let ter = terminalState();
...
function terminalState() {
    // -1 O win ; 0 Path ; 1 X win ; 2 Not terminate
    for (let r = 0; r < 3; r++) {
        if (board[r][0] == board[r][1] && board[r][1] == board[r][2] && board[r][0] == 'X') {
            return 1;
        }
    }
    for (let c = 0; c < 3; c++) {
    ...
    for (let r = 0; r < 3; r++) {
        if (board[r][0] == board[r][1] && board[r][1] == board[r][2] && board[r][0] == 'O') {
            return -1;
        }
    }
    for (let c = 0; c < 3; c++) {
