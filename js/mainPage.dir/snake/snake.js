...
//snake head
var startSnakeX = Math.floor(Math.random() * cols);
var startSnakeY = Math.floor(Math.random() * rows);
...
function update() {
    ...
    context.fillRect(foodX + blockSize/2 - 8, foodY, 16, 4);
